    ...
    <>
      <div className="containt">
        <div className="div_sec">
          ...
          my name is <span className="span_">akshay</span>.i am a web developer
          and machine learning developer.I always been pationated to learn new
          skills which ads value in my life .this is my personal portfolio
          website and thanks to going through it.
        </div>
        <div className="div_sec">
          <h3>Experience</h3>
          <div className="body_sec"></div>
          <div className="intern1">
            ...
            <ul className="projects">
              ...
              <li>
                ...
                <li>
                  <a href="https://github.com/akshaysutar8860/files/blob/main/ETGSI12813.pdf">
          ...
          <div className="intern2">
            ...
            <ul className="projects">
              <li>
                ...
                <a href="//">code</a>
                <li>
                  <a href="https://github.com/akshaysutar8860/files/blob/main/464cd5e2-a5d3-4abf-bd37-159f35f60200-merged.pdf">
                    {" "}
        ...
        <div className="div_sec">
          ...
          <p>
            ...
            <p>Marks:90%</p>
            HSC:
            <p>college name:Devchand college arjunnagar</p>
            <p>Marks:68.40%</p>
          </p>
        </div>
        <div className="div_sec">
